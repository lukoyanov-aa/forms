    ...
    <div class='container'>
        <div class="main-form row">
            ...
            <div class="col-md-10">
                ...
                ?>
                <div class="row">
                    <div class=" form-group goal col-xs-8 col-sm-4 col-md-4">
                        <?=
                                $form
                                ->field($model, 'doorType')
                                ->dropDownList($doorTypes, ['class' => 'form-control rounded-0'])
                                ->label('Тип дверей')
                        ?>                        
                    </div>
                    <div class="form-group gate col-xs-4 col-sm-2 col-md-2">
                        <?=
                    ...
                    <div class="form-group gate col-xs-6 col-sm-3 col-md-3">
                        <?=
                                $form->field($model, 'doorWidth')
