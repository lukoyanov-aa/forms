...
JS;
$this->registerJs($js);
$this->registerCssFile($assetsUrl->baseUrl . '/css/gate-rolling-doorhan.css');
    ...
    <div class='container'>
        <div class="main-form row">
            ...
            <div class="col-md-8">
                ...
                ?>            
                <div class="row">
                    <div class="goal col-xs-12 col-sm-4 col-md-4">
                        <?=
                                $form
                                ->field($model, 'gatePlace')
                                ->dropDownList($gatePlaces, ['class' => 'form-control rounded'])
                                ->label('Место установки')
                        ?>
                    </div>
                    <div class="gate col-xs-6 col-sm-4 col-md-4">
                        <?=
