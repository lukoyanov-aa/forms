...
JS;
$this->registerJs($js);
$this->registerCssFile($assetsUrl->baseUrl . '/css/gate-sliding-own.css');
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-md-12"> 
                                        <?=
                                                $form->field($model, 'roller')->dropDownList([
                                                    'Консольные',
                                                    'На ролике',
