...
JS;
$this->registerJs($js);
$this->registerCssFile($assetsUrl->baseUrl . '/css/gate-industrial-doorhan.css');
?>
    ...
    <div class='container'>
        <div class="main-form row">
            ...
            <div class="col-md-8">
                ...
                ?> 
                <div class="row">
                    <div class=" form-group goal col-xs-12 col-sm-4 col-md-4">
                        <?=
                                $form
                                ->field($model, 'gatePlace')
                                ->dropDownList($gatePlaces, ['class' => 'form-control rounded-0'])
                                ->label('Место установки')
                        ?>
                    </div>
                    <div class="form-group gate col-xs-6 col-sm-4 col-md-4">
                        <?=
