...
?>
<div class="mail-fields-view">

    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        <?= Html::a('Изменить', ['update', 'id' => $model->iid], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('Удалить', ['delete', 'id' => $model->iid,  'form_id'=>$model->iforms_id, 'tab'=>'mail' ], [
        ...
        <?= Html::a('Отмена', ['settings/forms/view', 'id' => $model->iforms_id, 'tab'=>'mail'], ['class' => 'btn btn-primary']) ?>
    </p>
